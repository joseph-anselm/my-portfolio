...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className={`bg-blue-200 ${isScrolled ? "fixed top-0 left-0 right-0 z-10" : ""}`}>
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <Link href="/">
                    <Image
                      className={`h-12 w-24 lg:block ${isScrolled ? "hidden" : ""}`}
                      src="/images/logo3.png"
                      alt="Jojo"
                      height={48}
                      width={96}
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                >
                  <span className="sr-only">View notifications</span>
                  <Link href="https://wa.me/2348032516519" target="_blank" rel="noopener noreferrer">
                    ...
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none self-center">
                      <Menu.Item>
                        {({ active }) => (
                          <Link
                            target="_blank"
                            href="/JOSEPH_ANSELM Profile.pdf"
                            download
                            className={classNames(
                              active ? "bg-gray-100" : "",
                              "block px-4 py-2 text-sm text-gray-700"
